...
const AffiliationProcessCard = ({ step, title, description }: StepCardProps) => {
  return (
    <div className="affiliation-processcard-container">
      <span className="affiliation-processcard-step">{step}</span>
      <h3 className="affiliation-processcard-title">{title}</h3>
      <p className="affiliation-processcard-description">{description}</p>
    </div>
  );
};
